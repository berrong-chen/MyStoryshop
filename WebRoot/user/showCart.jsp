			...
			<div class="header_container">
				...
				<div class="top_bar clear">
					...
					<ul class="top_links fr">
						...
						<li><a href="#">我的账户</a></li>
						<li class="highlight"><a href="${shop}/user/showCart.jsp">购物车</a></li>
						<li><a href="#">注册</a></li>
					...
					<h1 class="logo clear fl">
						<a href="${shop}/index.jsp"> <img src="${shop}/images/logo.png"/> </a>
					</h1>
					<!-- 小购物车 -->
					<div class="minicart">
		...
		<div class="navigation_container">
			...
			<div class="nav">
				<ul class="primary_nav">
					<li class="active highlight"><a href="#">生活</a> <!--二级菜单-->
						<ul class="sub_menu">
							<li><a href="#">裙装</a>
								<ul>
