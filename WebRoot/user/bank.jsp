            ...
            <div class="header_container">
                ...
                <div class="top_bar clear">
                    ...
                    <ul class="top_links fr">
                        ...
                        <li>
                            <a href="${shop}/user/showCart.jsp">购物车</a>
                        </li>
                        <li>
                            <a href="#">注册</a>
                        </li>
                ...
                <div class="pay">
                    <div class="pay-inner">
                        ...
                        <div class="fl yibao-logo">
                             <a href=""><img src="${shop}/files/bankImages/ABC-NET.gif" width="110" height="35" alt="" /></a>
                        </div>
                        <div class="fr blue aa">请转账:6XXX XXXX XXXX XXX
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="red"href="http://jingyan.baidu.com/article/b0b63dbfded3b64a4830702f.html">如何使用?</a>
                        </div>
